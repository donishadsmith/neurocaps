The HCPex parcellation is an extension of the HCP (Human Connectome Project) parcellation, which adds 66 subcortical areas [^1], [^2]. This original atlas can be downloaded from https://github.com/wayalan/HCPex.
