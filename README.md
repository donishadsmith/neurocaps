...
`QueueHandler` internally) and `QueueListener`. This approach allows logs produced by the internal `_extract_timeseries`
function to be redirected when parallel processing is enabled.
