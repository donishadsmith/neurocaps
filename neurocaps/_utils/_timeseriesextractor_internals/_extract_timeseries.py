...
def _extract_timeseries(subj_id, nifti_files, mask_files, event_files, confound_files, confound_metadata_files,
    ...
    for run in run_list:
        ...
        if signal_clean_info["use_confounds"]:
            # Extract first "n" numbers of specified WM and CSF components; acompcor extraction from fmriprep json files implementation from Michael Riedel & JulioAPeraza at https://github.com/NBCLab/abcd_fmriprep-analysis/blob/5ffd3ba2d6e6d56344318abdd90c8f2f19a93101/analysis/rest/denoising.py#L111
