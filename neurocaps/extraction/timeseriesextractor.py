...
class TimeseriesExtractor(_TimeseriesExtractorGetter):
    ...
    ----------
        ...
        parcel_approach : Dict[str, Dict], default={"Schaefer": {"n_rois": 400, "yeo_networks": 7, "resolution_mm": 1}}
            ...
            atlas name. Currently, only "Schaefer", "AAL", and "Custom" are supported.
                 ...
                 - For "Schaefer", available sub-keys include ``n_rois``, ``yeo_networks``, and ``resolution_mm``. Refer
                   to Nilearn's documentation for ``datasets.fetch_atlas_schaefer_2018`` for valid inputs.
        ...
        confound_names : List[str] or None, default=None
            Specifies the names of confounds to use from confound files. If None, default confounds are used. **Note**, 
            an asterisk ("*") can be used to find confound names that start with the term preceding the asterisk.
        ...
        fd_threshold : float or None, default=None
            ...
            column named `framewise_displacement` in the confounds Dataframe and use_confounds set to True.
    ...
    **If using a "Custom" parcellation approach**, ensure each node in your dataset includes both left (lh) and right
    ...
    - ``regions``: Dictionary defining major brain regions. Each region should list node indices under "lh" and "rh" to
      specify left and right hemisphere nodes. For timeseries extraction, this key is not required.
        ...
        **Get BOLD Data**
        ...
        ----------
            ...
            pipeline_name : str or None, default=None
                ...
                BIDSLayout will use the name of ``dset_dir`` with ``derivatives=True``. This parameter
        ...
        must consist of the timeseries (as a numpy array) associated with that run.
    ...
    def visualize_bold(self, subj_id: Union[int,str], run: int,
                       roi_indx: Optional[Union[int, List[int]]]=None,
        ...
        **Plot BOLD Data**
        ...
        ----------
            ...
            region : str or None, default=None
                ...
                then plotted. See "regions" in ``self.parcel_approach``.
